...
classes defined by spec section 4.7:
  ...
  (d) Any external (matthew-dresden/terraform-modules) source that was variable-ized
...
Configuration read from parameters, never inline literals:
  CONST_SOURCE_GUARD_EXTERNAL_HOST -- git host for the external terraform-modules org
                                      (default: github.com/matthew-dresden/terraform-modules)
...
_DEFAULT_EXTERNAL_HOST = "github.com/matthew-dresden/terraform-modules"
