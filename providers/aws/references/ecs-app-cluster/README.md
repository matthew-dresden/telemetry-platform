...
module "ecs_app_cluster" {
  source = "git::https://github.com/example-org/telemetry-platform.git//providers/aws/references/ecs-app-cluster?ref=providers/aws/references/ecs-app-cluster/v1.0.0"
