...
module "dns_prod_zone" {
  source = "git::https://github.com/example-org/telemetry-platform.git//providers/aws/references/dns-prod-zone?ref=providers/aws/references/dns-prod-zone/v1.0.0"
