variable "bucket_prefix" {
  type        = string
  description = "(Required) Prefix for the access-log and artifact S3 buckets."
  default     = "state-bootstrap-test"
}

variable "kms_alias" {
  type        = string
  description = "(Required) Alias suffix for the state KMS CMK."
  default     = "state-bootstrap/state"
}
