...
```hcl
module "route_table" {
  source = "git::https://github.com/matthew-dresden/telemetry-platform.git//providers/aws/primitives/route-table?ref=providers/aws/primitives/route-table/v0.1.0"
