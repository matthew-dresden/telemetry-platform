...
variable "load_balancer_arn_override" {
  type        = string
  description = "When non-null, passed directly to the module as load_balancer_arn instead of the fixture ALB ARN. Use in validation error tests to supply invalid ARNs."
  default     = null
}
...
variable "certificate_domain" {
  ...
  default     = "alb-listener-https.example.internal"
}
