...
output "autoscaling_target_resource_id" {
  description = "The autoscaling target resource ID."
...
output "alb_arn" {
  description = "The ARN of the fixture ALB."
  value       = aws_lb.fixture.arn
}

output "target_group_arn" {
  description = "The ARN of the fixture target group."
  value       = aws_lb_target_group.fixture.arn
}
