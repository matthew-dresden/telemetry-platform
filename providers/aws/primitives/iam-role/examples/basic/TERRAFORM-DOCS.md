# iam-role basic example -- terraform-docs reference
...
| description | Description of the IAM role. | string | "ECS tasks execution role -- basic example" | no |
...
| managed_policy_arns | List of managed policy ARNs to attach. | list(string) | ["arn:aws:iam::aws:policy/service-role/AmazonECSTaskExecutionRolePolicy"] | no |
