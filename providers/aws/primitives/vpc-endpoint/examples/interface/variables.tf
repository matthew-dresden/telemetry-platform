...
variable "private_subnet_cidr" {
  type        = string
  description = "CIDR block for the private fixture subnet."
  default     = "10.0.1.0/24"
...
variable "availability_zone" {
  type        = string
  description = "Availability zone for the private fixture subnet."
  default     = "us-east-1a"
}
...
variable "endpoints" {
  ...
  description = "Override endpoints list. When null, the fixture creates one SSM interface endpoint."
  default     = null
}
