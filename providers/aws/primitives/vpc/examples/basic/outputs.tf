...
output "vpc_cidr_block" {
  ...
  value       = module.example.vpc_cidr_block
}

output "vpc_ipv6_cidr_block" {
  description = "IPv6 CIDR block of the VPC"
  value       = module.example.vpc_ipv6_cidr_block
}

output "vpc_main_route_table_id" {
  description = "ID of the main route table"
  value       = module.example.vpc_main_route_table_id
}

output "vpc_default_security_group_id" {
  description = "ID of the default security group"
  value       = module.example.vpc_default_security_group_id
}

output "vpc_enable_dns_support" {
  description = "Whether DNS support is enabled"
  value       = module.example.vpc_enable_dns_support
}

output "vpc_enable_dns_hostnames" {
  description = "Whether DNS hostnames are enabled"
  value       = module.example.vpc_enable_dns_hostnames
}

output "vpc_instance_tenancy" {
  description = "Instance tenancy of the VPC"
  value       = module.example.vpc_instance_tenancy
}
