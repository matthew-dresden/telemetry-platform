# live/telemetry/us-east-1/sandbox/000/identity/000/service_instance.hcl
#
# Service instance layer for the sandbox identity unit.
# Basename resolves to "000" per the canonical layer idiom (spec 02 Section 1.3).
#
# Instance "000" is the canonical singleton for the identity unit in the sandbox
# account. A second instance (e.g. "001") would imply a second independent identity
# stack, which is not a supported pattern for this service. The "000" label is
...
# identity unit carries no per-instance flag (unlike dns-prod-zone, which exposes
