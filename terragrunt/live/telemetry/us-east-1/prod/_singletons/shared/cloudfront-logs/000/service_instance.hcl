# live/telemetry/us-east-1/<env>/_singletons/shared/cloudfront-logs/000/service_instance.hcl
#
# Service instance layer for the cloudfront-logs unit.
# Basename resolves to "000" per the canonical layer idiom (spec 02 Section 1.3).
#
# Instance "000" is the canonical singleton for the CloudFront standard-access-logging
# destination bucket. A second instance (e.g. "001") would imply a second independent
# log-destination bucket, which is not a supported pattern for this terminal log target.
