...
#
# Service instance layer for the root qa dns-delegation unit.
...
# qa environment. The "000" label is intentional and permanent.
#
...
locals {
  ...
  # remote_state key: qa/000/dns-delegation/000/terraform.tfstate
