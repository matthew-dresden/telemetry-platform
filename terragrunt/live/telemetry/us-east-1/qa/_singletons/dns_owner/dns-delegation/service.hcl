...
#
# Service layer for the root qa dns-delegation unit (<dns-owner-account>).
...
# qa.telemetry.example.com from the DNS-owner zone
# (telemetry.example.com). The NS records come from the
# name_servers output of the qa dns-prod-zone unit via a five-dotdot
