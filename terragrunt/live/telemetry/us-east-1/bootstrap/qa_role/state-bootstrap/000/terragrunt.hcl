# live/telemetry/us-east-1/bootstrap/qa_role/state-bootstrap/000/terragrunt.hcl
#
# Per-account state-bootstrap unit.
# Creates the remote-state foundation for the qa account via references/state-bootstrap:
...
#     BOOTSTRAP_LOCAL_BACKEND=true AWS_PROFILE=qa terragrunt apply
...
#     AWS_PROFILE=qa terragrunt apply
...
#
# Applied once with AWS_PROFILE=qa admin credentials.
