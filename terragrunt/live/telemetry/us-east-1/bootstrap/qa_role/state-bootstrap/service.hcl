# live/telemetry/us-east-1/bootstrap/qa_role/state-bootstrap/service.hcl
#
# Service layer for the qa state-bootstrap unit.
# Basename resolves to "state-bootstrap" per the canonical layer idiom (spec 02 Section 1.3).
#
# This unit creates the remote-state foundation for the qa account:
...
#
# Applied once with AWS_PROFILE=qa admin credentials. The own-state local-backend
