# live/telemetry/us-east-1/bootstrap/prod_role/state-bootstrap/000/terragrunt.hcl
#
# Prod account (111111111111) state-bootstrap unit.
# Creates the remote-state foundation for the prod account via the state-bootstrap module:
#   - state CMK (KMS customer managed key, alias/111111111111-tfstate)
#   - access-log bucket (111111111111-tfstate-access-logs)
#   - artifact bucket / S3 state bucket (111111111111-tfstate)
...
# The prod account id is 111111111111. A wrong-profile apply will fail fast because
