# live/telemetry/us-east-1/bootstrap/prod_role/state-bootstrap/service.hcl
#
# Service layer for the prod state-bootstrap unit.
# Basename resolves to "state-bootstrap" per the canonical layer idiom (spec 02 Section 1.3).
#
# This unit creates the remote-state foundation for the prod account:
...
#
# Applied once with prod admin credentials. The own-state local-backend override
