# live/telemetry/us-east-1/bootstrap/sandbox_role/state-bootstrap/000/service_instance.hcl
#
# Service instance layer for the sandbox state-bootstrap unit.
...
# service in the sandbox bootstrap layer). No per-instance overrides are needed
