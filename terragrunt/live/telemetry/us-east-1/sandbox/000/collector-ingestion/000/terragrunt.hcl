...
terraform {
  ...
  source = local.account_vars.locals.use_pinned_module_sources ? "${include.root.locals.module_git_base}//providers/aws/references/collector-ingestion?ref=providers/aws/references/collector-ingestion/v1.0.5" : "${get_repo_root()}//providers/aws/references/collector-ingestion"
}
...
locals {
  ...
  # composed by the root terragrunt.hcl (e.g. "telemetry-useast1-sandbox-000-collector_ingestion-000";
