...
terraform {
  ...
  source = local.account_vars.locals.use_pinned_module_sources ? "${include.root.locals.module_git_base}//providers/aws/references/data-lake?ref=providers/aws/references/data-lake/v2.1.0" : "${get_repo_root()}//providers/aws/references/data-lake"
}
